...
public class ProcessorInfoFactory {
    ...
    public static ProcessorInfo getCleanProcessorInfo(DeliveryType deliveryType, String owner, Node node, Service service, String serviceName) {
        return new ProcessorInfo(deliveryType, owner, node, service, serviceName);
    }
